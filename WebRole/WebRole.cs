...
namespace WebRole
{
    public class WebRole : RoleEntryPoint
    {
        public override bool OnStart()
        {
            GenUtils.PriorityLogMsg("DEBUG", "WebRole: OnStart", "MVC4");
            return base.OnStart();
        }
        ...
        public override void OnStop()
        {
            GenUtils.PriorityLogMsg("DEBUG", "WebRole: OnStop", "MVC4");
        ...
        public override void Run()
        {
            GenUtils.PriorityLogMsg("DEBUG", "WebRole: Run", "MVC4");
        ...
        protected void Application_Error(object sender, EventArgs e)
        {
            GenUtils.PriorityLogMsg("DEBUG", "WebRole: Application_Error", "MVC4");
            var ts = TableStorage.MakeDefaultTableStorage();
            Exception exception = HttpContext.Current.Server.GetLastError();
            GenUtils.PriorityLogMsg("exception", "Application_Error", exception.Message);
            // see http://azuremiscellany.blogspot.com/2010/05/web-role-crash-dumps.html for interesting possibility

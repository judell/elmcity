...
var end = ''; // for now
var summary = elt.find('.ttl').find('a').text();
...
elt.find('.menu').remove();
elt.append(
  '<ul class="menu"><li><a title="add this event to your Google calendar" href="javascript:add_to_google(' + quoted_id + ')">add to Google Calendar</a></li></ul>' +
  '<ul class="menu"><li><a title="add this event to your Hotmail calendar" href="javascript:add_to_hotmail(' + quoted_id + ')">add to Hotmail Calendar</a></li></ul>' +
  '<ul class="menu"><li><a title="add to your Outlook, Apple iCal, or other iCalendar-aware desktop calendar" href="javascript:add_to_ical(' + quoted_id + ')">add to iCal</a></li></ul>' +
  '<ul class="menu"><li><a title="add to Facebook" href="javascript:add_to_facebook(' + quoted_id + ')">add to Facebook</a></li></ul>' +
  '<ul class="menu"><li><a title="dismiss this menu" href="javascript:dismiss_menu(' + quoted_id + ')">cancel</a>'

...
//       break;
    ...
    if ( typeof (img_url) != 'undefined' && img_url.contains('NoCurrentImage') == false )
      cat_images += '<a title="' + cat + '"><img alt="' + cat + '" style="float:left;margin:8px;width:100px" src="' + img_url + '"></a>'
    }
  }
catch (e) {
  console.log(e.message);
...
try {
  ...
  if ( typeof (latlon ) != 'undefined' ) {
    ...
    var iframe = '<iframe src="' + map_url + '" width="600" height="500" scrolling="no" seamless="seamless"></iframe>';
...
try {
  ...
  if ( typeof (lat) != 'undefined' && typeof(lon) != 'undefined' ) {
    ...
    var iframe = '<iframe style="margin-top:20px" src="' + map_url + '" width="600" height="500" scrolling="no" seamless="seamless"></iframe>';
    description = description + iframe;
    }
  }
catch (e) {

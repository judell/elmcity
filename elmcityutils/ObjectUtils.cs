...
namespace ElmcityUtils
{
    public static class ObjectUtils
    {
        ...
        public static Object DictObjToObj(Dictionary<string, object> dict_obj, Type type)
        {
            ...
            {
                GenUtils.LogMsg("exception", "DictObjToObj: " + type.Name, "target type does not define properties");
                return o;
            }
            ...
            foreach (var key in dict_obj.Keys)
            {
                ...
                {
                    // this is normal since an azure table includes PartitionKey, RowKey, and Timestamp which
                    // will not be part of the object
                }
                catch (Exception e)
                {
                    GenUtils.LogMsg("exception", "DictObjToObj: " + type.Name, e.Message + e.StackTrace);
                }
            }
